...
Pentru a apela toata munca noastra, se intra in fisierul convert.py care inglobeaza toate celelalte fisiere .py, iar pe ultima linie, 
se pune path-ul unui folder care poate contine mai multe fisiere cu terminatii diferite. Daca aceste fisiere au terminatia .doc, .docx sau .pdf, sunt apelate functiile descrise mai jos.
...
EXEMPLU: daca intr-un folder vom avea 2 fisiere: unu.docx si doi.pdf, in urma apelarii functiei din convert.py, tot in acel folder vor 
aparea alte 2 fisiere: unu.txt si doi.txt
